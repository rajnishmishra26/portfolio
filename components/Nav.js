...
const Nav = () => {
  ...
  return (
    <nav
      ...
      bottom-0 
      mt-auto xl:right-[2%] z-50 top-0 w-full xl:w-16 xl:max-w-md  
      xl:h-screen`}
    >
      <div
        className={`flex w-full xl:flex-col items-center 
          justify-between xl:justify-center gap-y-10 px-4 md:px-40 xl:px-0 h-[80px] bg-red-200/10 xl:h-max
          ...
          return (
            ...
            >
              <div className="absolute pr-14 right-0 hidden xl:group-hover:flex">
                <div
                  className={
                    "bg-white relative flex text-primary items-center p-[6px] rounded-[3px]"
                  }
                >
